  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-10">
          <input type="text" name="nmnasabah" class="form-control">
        </div>
      </div>
      <div class="mb-3 row">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-10">
          <input type="text" name="kemampuan" class="money form-control">
        </div>
      </div>
      <div class="mb-3 row">
        <label class="form-label col-sm-2">Nilai Jaminan</label>
        <div class="col-sm-10">
          <input type="text" name="njaminan" class="money form-control">
        </div>
      </div>
      <div class="mb-3 row">
        <label class="form-label col-sm-2">Pinjaman</label>
        <div class="col-sm-10">
          <input type="text" name="pinjaman" class="money form-control">
        </div>
      </div>
      <div class="mb-3 row">
